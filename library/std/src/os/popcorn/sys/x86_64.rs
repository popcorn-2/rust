...
pub macro syscall {
    ...
    (async($key:expr) $uid:expr, $arg0:expr) => {
        'syscall: {
            let uid = <u128 as ::core::convert::From<_>>::from($uid);
            let arg0: $crate::os::popcorn::io::RawHandle = $arg0;
            let key = <usize as ::core::convert::From<_>>::from($key);
            let low: u64;
            let high: u64;
            ::core::arch::asm!(
                "stc",
    ...
    (async($key:expr) $uid:expr, $arg0:expr, $arg1:expr) => {
        'syscall: {
            let uid = <u128 as ::core::convert::From<_>>::from($uid);
            let arg0: $crate::os::popcorn::io::RawHandle = $arg0;
            let arg1 = <usize as ::core::convert::From<_>>::from($arg1);
    ...
    (async($key:expr) $uid:expr, $arg0:expr, $arg1:expr, $arg2:expr) => {
        'syscall: {
            let uid = <u128 as ::core::convert::From<_>>::from($uid);
            let arg0: $crate::os::popcorn::io::RawHandle = $arg0;
            let arg1 = <usize as ::core::convert::From<_>>::from($arg1);
    ...
    (async($key:expr) $uid:expr, $arg0:expr, $arg1:expr, $arg2:expr, $arg3: expr) => {
        'syscall: {
            let uid = <u128 as ::core::convert::From<_>>::from($uid);
            let arg0: $crate::os::popcorn::io::RawHandle = $arg0;
            let arg1 = <usize as ::core::convert::From<_>>::from($arg1);
    ...
    (async($key:expr) $uid:expr, $arg0:expr, $arg1:expr, $arg2:expr, $arg3:expr, $arg4:expr) => {
        'syscall: {
            let uid = <u128 as ::core::convert::From<_>>::from($uid);
            let arg0: $crate::os::popcorn::io::RawHandle = $arg0;
            let arg1 = <usize as ::core::convert::From<_>>::from($arg1);
